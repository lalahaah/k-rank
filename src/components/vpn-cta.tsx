        ...
        <div className="w-full bg-gradient-to-r from-blue-600 to-blue-800 py-16">
            <div className="mx-auto max-w-[1020px] px-4">
                <div className="text-center">
                    ...
                    >
                        <button className="bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-bold hover:bg-blue-50 transition-all transform hover:scale-105 active:scale-95 shadow-xl">
                            🔓 Unlock with NordVPN
                        </button>
                    </a>
