...
export const AD_CONFIG = {
    ...
    billboard: {
        ...
        linkText: "Shop Now",
        linkUrl: `https://www.amazon.com/s?k=korean+sunscreen&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_ID || 'nextidealab-20'}`, // 대표님의 아마존 태그 포함 링크
    },
    // 2번: 리스트 중간 광고 (인피드)
    inFeed: {
    ...
    sidebar: {
        ...
        linkUrl: `https://www.amazon.com/Medicube-Zero-Pore-Pads-Dual-Textured/dp/B09V7Z4TJG?tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_ID || 'nextidealab-20'}`,
