...
CATEGORY_MAPPING = {
    'skincare': {'firestore_category': 'beauty'},
    'suncare': {'firestore_category': 'beauty'},
    'masks': {'firestore_category': 'beauty'},
    'makeup': {'firestore_category': 'beauty'},
    'beauty': {'firestore_category': 'beauty'},
    'all': {'firestore_category': 'beauty'}
}

CACHE_FILE = os.path.join(script_dir, 'gemini_cache.json')
